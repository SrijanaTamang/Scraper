...
def CB8(ical,session):
    ...
    #add time,date, title and detaisls and add to events_dict
...
CB8('https://www.cb8m.com/calendar/?ical=1',session)
...
#print all users
for event in session.query(Event).filter(Event.district == 108):
    print(event,'\n\n')
